  ...
  return (
    <>
      ...
      <div className="h-screen overflow-auto bg-[#18181C] text-[#D4D4D8]">
        <a className="absolute top-0 right-12 p-4 cursor-pointer" href="https://www.threads.net/@officialsphrex" target="_blank" rel="noreferrer">
          <IconBrandTwitter />
        </a>

        <a className="absolute top-0 right-2 p-4 cursor-pointer" href="/promptbar" target="_blank" rel="noreferrer">
          <IconNotification />
        </a>
